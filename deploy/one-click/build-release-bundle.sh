...
# Auto-pause lifecycle coordination lives in the standalone
# cube-lifecycle-manager image now; see the CLM packaging block below for
# how its build context is assembled.
